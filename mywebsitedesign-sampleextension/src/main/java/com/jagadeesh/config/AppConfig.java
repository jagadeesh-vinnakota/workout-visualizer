...
@ComponentScans(value = { @ComponentScan("com.jagadeesh.dao"),
      @ComponentScan("com.jagadeesh.service") })


//A class for setting up the hibernate configuration
public class AppConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      factoryBean.setAnnotatedClasses(TestUser.class,UserData.class,WorkoutDetails.class,ImageUser.class,RecommondUser.class,LoginUser.class,Authorities.class);
      return factoryBean;
   }
