		...
		<div class="card" style="border-color:lightblue;">
			...
			<div class="card-body">
				<form:form action="${pageContext.request.contextPath}/saveuser" 
						  method="POST" modelAttribute="testuser" class="form">
					...
					<div class="form-row">
						...
						<div class="form-group">
		                		...
		                		<form:input type="text" path="name" id="username" class="form-control" placeholder="username"/>
		            			</div>
		            	</div> <!-- End of Email -->					  
					...
					<div class="form-row">
						...
						<div class="form-group">
		                		...
		                		<form:input type="password" path="pass" id="password" class="form-control" placeholder="password"/>
		            			</div>
		            	</div> <!-- End of Email -->					  
					  </div> <!-- End of Email column -->
					</div>
